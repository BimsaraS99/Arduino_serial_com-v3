...
def Find_Edge(image_send):
    try:
        ...
        for contour in contours:
            if cv2.contourArea(contour) >= 2 and cv2.contourArea(contour) <= shadow_size:
        ...
        lines = cv2.HoughLines(contour_img, 1, np.pi / 180, 5)
...
#cap = cv2.VideoCapture('A:/Internship MAS/03.03.2023/edge detector dataset/video11.mp4')
